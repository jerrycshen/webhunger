...
public class SpiderStatus implements SpiderStatusMXBean {
    ...
    public int getLeftPageCount() {
        ...
        logger.warn("Get leftPageCount fail, try to use a Scheduler implement MonitorableScheduler for cn.edu.zju.eagle.monitor count!");
        return -1;
    }
    ...
    public int getTotalPageCount() {
        ...
        logger.warn("Get totalPageCount fail, try to use a Scheduler implement MonitorableScheduler for cn.edu.zju.eagle.monitor count!");
        return -1;
    }
