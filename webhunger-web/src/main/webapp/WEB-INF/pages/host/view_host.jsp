...
<div class="container">
    ...
    <div class="page-header">
        <ul class="nav nav-pills" role="tablist">
            ...
            <li>
                <button id="waitingBtn" class="btn btn-success" type="button" style="margin-left: 5px">
            ...
            <li>
                <button id="suspendBtn" class="btn btn-warning" type="button" style="margin-left: 5px">
                    Suspend <span id="suspendBadge" class="badge"></span>
                </button>
            </li>
            <li>
                <button id="canceledBtn" class="btn btn-danger" type="button" style="margin-left: 5px">
                    Canceled <span id="canceledBadge" class="badge"></span>
                </button>
            </li>
            <li>
            ...
            <li class="navbar-right" style="margin-left: 5px; margin-right: 5px">
                <button id="createHostBtn" class="btn btn-default" type="button" onclick="createHost('${task_id}')">
                    Create Host
                </button>
            </li>
        </ul>
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    if (row.state === 0) {
                        ...
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Re-Start</button>";
                    } else if (row.state === 1) {
                        ...
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Suspend</button> ";
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Stop</button> ";
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' onclick='reStartCrawler("+data+")'>Re-Start</button>";
                    } else if (row.state === -1) {
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Start</button> ";
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Suspend</button> ";
                        buttonStr += "<button type='button' class='btn btn-default btn-sm' disabled>Stop</button> ";
